    ...
    <main>
      ...
      <section className="paymentSection" aria-label="Оплата доставка и гарантия">
        <div className="sectionHead">
          ...
          <p>Коротко отвечаем на главные вопросы перед заказом: как получить устройство, как проходит оплата и какая гарантия действует на новые устройства.</p>
        </div>
        <div className="serviceGrid">
          ...
          <article>
            ...
            <p>Максимальная скидка при оплате наличными. Все цены на сайте указаны за наличный расчет. При выборе других способов оплаты итоговую стоимость уточняйте.</p>
          </article>
          <article>
            <span>03</span>
