  ...
  return (
    <main>
      ...
      <section className="trustStrip" aria-label="Преимущества">
        ...
        <div>
          <span className="trustIcon checkIcon">✓</span>
          <strong>Поможем подобрать устройство, которое подойдет именно вам</strong>
        </div>
        <div>
          <span className="trustIcon checkIcon">✓</span>
          <strong>Поддержка до и после покупки — мы всегда на связи, если понадобится помощь</strong>
        </div>
      </section>
      ...
      <section className="paymentSection" aria-label="Оплата доставка и гарантия">
        ...
        <div className="serviceGrid">
          <article>
            ...
            <p>
              Мы предлагаем несколько способов оплаты заказа.
              <br />
              <br />
              Все цены, указанные на сайте, действительны только при оплате наличными и уже включают максимальную скидку.
              <br />
              <br />
              Цены и ассортимент регулярно обновляются в соответствии с актуальными предложениями поставщиков. Поэтому наличие товара и окончательная стоимость подтверждаются менеджером в рабочее время.
              <br />
              <br />
              При выборе других способов оплаты (банковской картой, безналичным расчетом и др.) итоговую стоимость уточняйте у менеджера при оформлении заказа.
              <br />
              <br />
              После оформления заказа мы обязательно свяжемся с вами, подтвердим наличие товара, актуальную стоимость и согласуем все детали.
              <br />
              <br />
              Заявки, оформленные вне рабочего времени, обрабатываются в начале следующего рабочего дня.
            </p>
          </article>
          <article>
            <span>02</span>
            ...
            <p>
              Мы предлагаем несколько удобных способов получения заказа. При оформлении покупки вы можете выбрать самовывоз или доставку. После оформления заказа мы обязательно свяжемся с вами, подтвердим заказ и согласуем все детали.
              <br />
              <br />
              <b>Самовывоз</b>
              <br />
              <br />
              Самовывоз осуществляется из пункта выдачи заказов по адресу:
              <br />
              г. Москва, Багратионовский проезд, 7к3
              <br />
              <br />
              Режим работы:
              <br />
              ПН–ПТ: с 11:00 до 18:30
              <br />
              СБ–ВС: с 11:00 до 17:30
              <br />
              <br />
              По предварительному согласованию выдача заказа возможна в более позднее время.
              <br />
              <br />
              Мы работаем в формате выдачи предварительно оформленных заказов, поэтому перед визитом необходимо оформить заказ. После подтверждения заказа мы согласуем удобное время получения.
              <br />
              <br />
              <b>Доставка</b>
              <br />
              <br />
              Мы осуществляем доставку по Москве и г. Клинцы, а также по всей России транспортной компанией СДЭК.
              <br />
              <br />
              Срок доставки по России — от 1 до 3 рабочих дней (в зависимости от региона).
              <br />
              <br />
              Отправка заказов осуществляется ежедневно. После передачи заказа в службу доставки мы отправим вам трек-номер для отслеживания посылки.
            </p>
          </article>
          <article>
            <span>03</span>
            ...
            <p>
              Мы продаем только оригинальную технику Apple. На все новые устройства действует 1 год официальной гарантии производителя в соответствии с условиями Apple.
              <br />
              <br />
              Кроме того, эпсейл стор предоставляет 30 дней дополнительной гарантии от магазина на выявление производственных (заводских) дефектов с момента покупки.
              <br />
              <br />
              Как правило, производственные дефекты, если они присутствуют, проявляются в первые дни эксплуатации устройства. Именно поэтому мы предоставляем дополнительную гарантию на этот период, чтобы вы могли быть уверены в качестве своей покупки.
            </p>
          </article>
        </div>
      </section>
